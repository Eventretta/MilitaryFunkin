...
class MasterEditorMenu extends MusicBeatState
{
	...
	public static var fromPlay:Bool = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.ACCEPT)
		{
			switch(options[curSelected]) {
				...
				case 'Replay Loader':
					MusicBeatState.switchState(new ReplayLoader());
				case 'Position Editor':
					MusicBeatState.switchState(new Position());
				case 'Gameplay Changers':
					openSubState(new GameplayChangersSubstate());
				case 'BACK':
					MusicBeatState.switchState((fromPlay ? new PlayState() : new MainMenuState()));
			}
