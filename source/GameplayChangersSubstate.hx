...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Challenge mode', 'challenge', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Opponent play', 'opponentPlay', 'bool', false);
		optionsArray.push(option);

		if (Main.exes)
		{
			var option:GameplayOption = new GameplayOption("The EXES will take over.", 'takeover', 'bool', false);
			optionsArray.push(option);
		}
	}
