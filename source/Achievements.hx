...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Mom i am in the credits!", "Get a legit private build (This achievment unlocks debug functions)", "password", true], // this isnt actually an achievement
		["Bambi Enjoyer",					"Unlock Bambi",	'bambiSong',				 true],
	];
