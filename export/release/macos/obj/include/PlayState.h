...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static void __boot();
		static bool osuMode;
		static bool forceCutscene;
		static int STRUM_X;
		static bool isReplay;
		static int STRUM_X_MIDDLESCROLL;
		static  ::Dynamic onLoad;
		static Dynamic onLoad_dyn() { return onLoad;}
		static ::Array< ::Dynamic> loadedReplay;
		...
		static ::Dynamic cancelMusicFadeTween_dyn();
		 ...
		 ::flixel::addons::ui::FlxInputText yInput;
		bool is3d;
		 ::flixel::FlxSprite daBox;
		bool tankVis;
		 ::HealthIcon icona;
		 ::flixel::FlxSprite rulerMechanic;
		::String letters;
		 ::Alphabet dietxt;
		Float redef;
		bool secret;
		 ::Player player;
		 ::flixel::FlxSprite fiuler;
		bool challenge;
		int power;
		::Array< ::String > die;
		 ::Alphabet text;
		...
		::String stageMode;
		 ::flixel::FlxSprite ruler;
		::Array< ::Dynamic> shaderUpdates;
		bool isWhat;
		int millisecond;
		::Array< ::Dynamic> wiggles;
		::Array< ::Dynamic> cameraPoss;
		::Array< ::Dynamic> presses;
		::Array< ::Dynamic> readder;
		 ...
		 ::flixel::FlxSprite tower;
		 ::flixel::FlxSprite tankRolling;
		...
		Float songSpeed;
		 ...
		 ::flixel::FlxSprite stage;
		 ::flixel::FlxCamera camSplash;
		 ::flixel::FlxCamera camIcons;
		 ::flixel::FlxCamera camScore;
		...
		int combo;
		 ...
		 ::AttachedSprite fhealthBarBG;
		 ::flixel::ui::FlxBar fhealthBar;
		Float songPercent;
		...
		::Array< ::String > dialogue;
		 ...
		 ::flixel::tweens::FlxTween effectTween;
		...
		void generateStaticArrows(int player,bool asc);
		...
		void prepareToDie();
		::Dynamic prepareToDie_dyn();

		bool doDeathCheck( ::Dynamic skipHealthCheck);
		::Dynamic doDeathCheck_dyn();

		void shootedInDaBalls();
		::Dynamic shootedInDaBalls_dyn();
		...
		void endCustsceneEarly();
		::Dynamic endCustsceneEarly_dyn();
		...
		void keyShit(::Array< bool > boolen);
		::Dynamic keyShit_dyn();
		...
		bool trainFinishing;
		int trainCooldown;
		void cameraMove( ::Note daNote, ::Character _hx_char);
		::Dynamic cameraMove_dyn();
