...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_36_new)
...
HXLINE(  51)		( ( ::Song)(__this) )->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  50)		( ( ::Song)(__this) )->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  49)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  48)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  45)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  42)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  88)		( ( ::Song)(__this) )->song = song;
HXLINE(  89)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  90)		( ( ::Song)(__this) )->bpm = bpm;
            	}
