...
static const ::String _hx_array_data_920159bb_22[] = {
	HX_("LEFT",07,d0,70,32),HX_("DOWN",62,c0,2e,2d),HX_("UP",5b,4a,00,00),HX_("RIGHT",bc,43,52,67),HX_("DOWN",62,c0,2e,2d),
};
HX_LOCAL_STACK_FRAME(_hx_pos_451d99b3fc57d4a2_147_postAddedToGroup,"StrumNote","postAddedToGroup",0x894c0b77,"StrumNote.postAddedToGroup","StrumNote.hx",147,0x345a6fe3)
HX_LOCAL_STACK_FRAME(_hx_pos_451d99b3fc57d4a2_155_update,"StrumNote","update",0x7186005c,"StrumNote.update","StrumNote.hx",155,0x345a6fe3)
HX_LOCAL_STACK_FRAME(_hx_pos_451d99b3fc57d4a2_172_playAnim,"StrumNote","playAnim",0x17d6df38,"StrumNote.playAnim","StrumNote.hx",172,0x345a6fe3)
...
HXDLIN(  47)		if (!(::PlayState_obj::isPixelStage)) {
HXLINE(  47)			_hx_tmp = ::hx::IsEq( ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic),HX_("tankbot",5d,31,70,3d) );
            		}
            		else {
...
HXLINE(  57)			this->animation->add(HX_("green",c3,0e,ed,99),::Array_obj< int >::fromData( _hx_array_data_920159bb_6,1),null(),null(),null(),null());
HXLINE(  58)			this->animation->add(HX_("red",51,d9,56,00),::Array_obj< int >::fromData( _hx_array_data_920159bb_7,1),null(),null(),null(),null());
HXLINE(  59)			this->animation->add(HX_("blue",9a,42,19,41),::Array_obj< int >::fromData( _hx_array_data_920159bb_8,1),null(),null(),null(),null());
HXLINE(  60)			this->animation->add(HX_("purple",3c,f6,89,71),::Array_obj< int >::fromData( _hx_array_data_920159bb_9,1),null(),null(),null(),null());
HXLINE(  61)			Float _hx_switch_0 = ::Math_obj::abs(( (Float)(this->noteData) ));
            			if (  (_hx_switch_0==( (Float)(0) )) ){
HXLINE(  64)				this->animation->add(HX_("static",ae,dc,fb,05),::Array_obj< int >::fromData( _hx_array_data_920159bb_10,1),null(),null(),null(),null());
HXLINE(  65)				this->animation->add(HX_("pressed",a2,d2,e6,39),::Array_obj< int >::fromData( _hx_array_data_920159bb_11,2),12,false,null(),null());
HXLINE(  66)				this->animation->add(HX_("confirm",00,9d,39,10),::Array_obj< int >::fromData( _hx_array_data_920159bb_12,2),24,false,null(),null());
HXLINE(  63)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==( (Float)(1) )) ){
HXLINE(  68)				this->animation->add(HX_("static",ae,dc,fb,05),::Array_obj< int >::fromData( _hx_array_data_920159bb_13,1),null(),null(),null(),null());
HXLINE(  69)				this->animation->add(HX_("pressed",a2,d2,e6,39),::Array_obj< int >::fromData( _hx_array_data_920159bb_14,2),12,false,null(),null());
HXLINE(  70)				this->animation->add(HX_("confirm",00,9d,39,10),::Array_obj< int >::fromData( _hx_array_data_920159bb_15,2),24,false,null(),null());
HXLINE(  67)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==( (Float)(2) )) ){
HXLINE(  72)				this->animation->add(HX_("static",ae,dc,fb,05),::Array_obj< int >::fromData( _hx_array_data_920159bb_16,1),null(),null(),null(),null());
HXLINE(  73)				this->animation->add(HX_("pressed",a2,d2,e6,39),::Array_obj< int >::fromData( _hx_array_data_920159bb_17,2),12,false,null(),null());
HXLINE(  74)				this->animation->add(HX_("confirm",00,9d,39,10),::Array_obj< int >::fromData( _hx_array_data_920159bb_18,2),12,false,null(),null());
HXLINE(  71)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==( (Float)(3) )) ){
HXLINE(  76)				this->animation->add(HX_("static",ae,dc,fb,05),::Array_obj< int >::fromData( _hx_array_data_920159bb_19,1),null(),null(),null(),null());
HXLINE(  77)				this->animation->add(HX_("pressed",a2,d2,e6,39),::Array_obj< int >::fromData( _hx_array_data_920159bb_20,2),12,false,null(),null());
HXLINE(  78)				this->animation->add(HX_("confirm",00,9d,39,10),::Array_obj< int >::fromData( _hx_array_data_920159bb_21,2),24,false,null(),null());
...
HXLINE(  91)			if (!(::PlayState_obj::osuMode)) {
...
HXLINE(  95)					goto _hx_goto_3;
            				...
            				if (  (_hx_switch_1==( (Float)(1) )) ||  (_hx_switch_1==( (Float)(5) )) ){
...
HXLINE( 120)				Float _hx_switch_2 = ::Math_obj::abs(( (Float)(this->noteData) ));
            				if (  (_hx_switch_2==( (Float)(0) )) ){
HXLINE( 123)					this->animation->addByPrefix(HX_("static",ae,dc,fb,05),HX_("arrowLEFT",50,62,3b,03),null(),null(),null(),null());
HXDLIN( 123)					goto _hx_goto_4;
            				}
            				if (  (_hx_switch_2==( (Float)(1) )) ||  (_hx_switch_2==( (Float)(5) )) ){
HXLINE( 125)					this->animation->addByPrefix(HX_("static",ae,dc,fb,05),HX_("arrowDOWN",ab,52,f9,fd),null(),null(),null(),null());
...
HXLINE( 129)					this->animation->addByPrefix(HX_("static",ae,dc,fb,05),HX_("arrowRIGHT",53,b1,c7,47),null(),null(),null(),null());
HXDLIN( 129)					goto _hx_goto_4;
            				}
            				/* default */{
HXLINE( 132)					this->animation->addByPrefix(HX_("static",ae,dc,fb,05),HX_("arrowRIGHT",53,b1,c7,47),null(),null(),null(),null());
            				}
            				_hx_goto_4:;
HXLINE( 134)				::Array< ::String > theArray = ::Array_obj< ::String >::fromData( _hx_array_data_920159bb_22,5);
HXLINE( 135)				this->animation->addByPrefix(HX_("pressed",a2,d2,e6,39),(HX_("arrow",c9,79,8f,25) + theArray->__get(this->noteData)),24,false,null(),null());
HXLINE( 136)				this->animation->addByPrefix(HX_("confirm",00,9d,39,10),(HX_("arrow",c9,79,8f,25) + theArray->__get(this->noteData)),24,false,null(),null());
            			}
            		}
HXLINE( 139)		this->updateHitbox();
HXLINE( 141)		if (::hx::IsNotNull( lastAnim )) {
HXLINE( 143)			this->playAnim(lastAnim,true);
            		}
            	}
...
void StrumNote_obj::postAddedToGroup(int pl){
            	HX_STACKFRAME(&_hx_pos_451d99b3fc57d4a2_147_postAddedToGroup)
HXLINE( 148)		this->playAnim(HX_("static",ae,dc,fb,05),null());
HXLINE( 149)		this->set_x((this->x + (::Note_obj::swagWidth * ( (Float)(this->noteData) ))));
HXLINE( 150)		this->set_x((this->x + 50));
HXLINE( 151)		this->set_x((this->x + ((( (Float)(::flixel::FlxG_obj::width) ) / ( (Float)(2) )) * ( (Float)(this->player) ))));
HXLINE( 152)		this->ID = this->noteData;
            	}


HX_DEFINE_DYNAMIC_FUNC1(StrumNote_obj,postAddedToGroup,(void))

void StrumNote_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_451d99b3fc57d4a2_155_update)
HXLINE( 156)		if ((this->resetAnim > 0)) {
HXLINE( 157)			 ::StrumNote _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 157)			_hx_tmp->resetAnim = (_hx_tmp->resetAnim - elapsed);
HXLINE( 158)			if ((this->resetAnim <= 0)) {
HXLINE( 159)				this->playAnim(HX_("static",ae,dc,fb,05),null());
HXLINE( 160)				this->resetAnim = ( (Float)(0) );
            			}
            		}
HXLINE( 164)		bool _hx_tmp;
HXDLIN( 164)		if ((this->animation->_curAnim->name == HX_("confirm",00,9d,39,10))) {
HXLINE( 164)			_hx_tmp = !(::PlayState_obj::isPixelStage);
            		}
            		else {
...
void StrumNote_obj::playAnim(::String anim, ::Dynamic __o_force){
            	...
            	HX_STACKFRAME(&_hx_pos_451d99b3fc57d4a2_172_playAnim)
HXLINE( 173)		this->animation->play(anim,force,null(),null());
HXLINE( 174)		this->centerOffsets(null());
HXLINE( 175)		this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
HXLINE( 176)		bool _hx_tmp;
HXDLIN( 176)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE( 176)			_hx_tmp = (this->animation->_curAnim->name == HX_("static",ae,dc,fb,05));
            		}
            		else {
HXLINE( 176)			_hx_tmp = true;
            		}
HXDLIN( 176)		if (_hx_tmp) {
HXLINE( 177)			this->colorSwap->set_hue(( (Float)(0) ));
HXLINE( 178)			this->colorSwap->set_saturation(( (Float)(0) ));
HXLINE( 179)			this->colorSwap->set_brightness(( (Float)(0) ));
            		}
            		else {
HXLINE( 181)			this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE( 182)			this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE( 183)			this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(::hx::Mod(this->noteData,4)).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
HXLINE( 185)			bool _hx_tmp;
HXDLIN( 185)			if ((this->animation->_curAnim->name == HX_("confirm",00,9d,39,10))) {
HXLINE( 185)				_hx_tmp = !(::PlayState_obj::isPixelStage);
            			}
            			else {
HXLINE( 185)				_hx_tmp = false;
            			}
HXDLIN( 185)			if (_hx_tmp) {
HXLINE( 186)				this->origin->set((( (Float)(this->frameWidth) ) * ((Float)0.5)),(( (Float)(this->frameHeight) ) * ((Float)0.5)));
            			}
            		}
            	}
