...
HX_DEFINE_STACK_FRAME(_hx_pos_f8fd466029c4d025_692_new,"ModMetadata","new",0x98e8f1a3,"ModMetadata.new","ModsMenuState.hx",692,0xc380473d)

void ModMetadata_obj::__construct(::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_f8fd466029c4d025_692_new)
HXLINE( 693)		this->folder = folder;
HXLINE( 694)		this->name = folder;
HXLINE( 695)		this->description = HX_("No description provided.",88,46,cb,66);
HXLINE( 696)		this->color = ::ModsMenuState_obj::defaultColor;
HXLINE( 697)		this->restart = false;
HXLINE( 700)		::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 700)		if (::hx::IsNull( key )) {
HXLINE( 700)			key = HX_("",00,00,00,00);
            		}
HXDLIN( 700)		::String path = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 701)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 702)			::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 703)			bool _hx_tmp;
HXDLIN( 703)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 703)				_hx_tmp = (rawJson.length > 0);
            			}
            			else {
HXLINE( 703)				_hx_tmp = false;
            			}
HXDLIN( 703)			if (_hx_tmp) {
HXLINE( 704)				 ::Dynamic stuff =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 706)				::Array< int > colors = ( (::Array< int >)(::Reflect_obj::getProperty(stuff,HX_("color",63,71,5c,4a))) );
HXLINE( 707)				::String description = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("description",fc,08,1d,5f))) );
HXLINE( 708)				::String name = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("name",4b,72,ff,48))) );
HXLINE( 709)				bool restart = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("restart",cf,c7,a5,6a))) );
HXLINE( 711)				bool _hx_tmp;
HXDLIN( 711)				if (::hx::IsNotNull( name )) {
HXLINE( 711)					_hx_tmp = (name.length > 0);
            				}
            				else {
HXLINE( 711)					_hx_tmp = false;
            				}
HXDLIN( 711)				if (_hx_tmp) {
HXLINE( 713)					this->name = name;
            				}
HXLINE( 715)				bool _hx_tmp1;
HXDLIN( 715)				if (::hx::IsNotNull( description )) {
HXLINE( 715)					_hx_tmp1 = (description.length > 0);
            				}
            				else {
HXLINE( 715)					_hx_tmp1 = false;
            				}
HXDLIN( 715)				if (_hx_tmp1) {
HXLINE( 717)					this->description = description;
            				}
HXLINE( 719)				bool _hx_tmp2;
HXDLIN( 719)				if (::hx::IsNotNull( colors )) {
HXLINE( 719)					_hx_tmp2 = (colors->length > 2);
            				}
            				else {
HXLINE( 719)					_hx_tmp2 = false;
            				}
HXDLIN( 719)				if (_hx_tmp2) {
HXLINE( 721)					int Red = colors->__get(0);
HXDLIN( 721)					int Green = colors->__get(1);
HXDLIN( 721)					int Blue = colors->__get(2);
...
HXDLIN( 721)					this->color = color;
            				}
HXLINE( 724)				this->restart = restart;
            			}
            		}
            	}
