...
HX_DEFINE_STACK_FRAME(_hx_pos_5355c1500aa58f96_337_new,"GameplayOption","new",0x2ac2d98d,"GameplayOption.new","GameplayChangersSubstate.hx",337,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_414_change,"GameplayOption","change",0x8d0dc263,"GameplayOption.change","GameplayChangersSubstate.hx",414,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_421_getValue,"GameplayOption","getValue",0x690f22ae,"GameplayOption.getValue","GameplayChangersSubstate.hx",421,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_425_setValue,"GameplayOption","setValue",0x176c7c22,"GameplayOption.setValue","GameplayChangersSubstate.hx",425,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_430_setChild,"GameplayOption","setChild",0x2b6da64d,"GameplayOption.setChild","GameplayChangersSubstate.hx",430,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_434_get_text,"GameplayOption","get_text",0xa4341be9,"GameplayOption.get_text","GameplayChangersSubstate.hx",434,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_441_set_text,"GameplayOption","set_text",0x5291755d,"GameplayOption.set_text","GameplayChangersSubstate.hx",441,0xb1374db6)
HX_LOCAL_STACK_FRAME(_hx_pos_5355c1500aa58f96_449_get_type,"GameplayOption","get_type",0xa44341f6,"GameplayOption.get_type","GameplayChangersSubstate.hx",449,0xb1374db6)
...
void GameplayOption_obj::__construct(::String name,::String variable,::String __o_type, ::Dynamic __o_defaultValue,::Array< ::String > options){
            	...
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_337_new)
HXLINE( 361)		this->name = HX_("Unknown",6a,4b,cc,ae);
HXLINE( 360)		this->displayFormat = HX_("%v",b1,20,00,00);
HXLINE( 358)		this->decimals = 1;
HXLINE( 357)		this->maxValue = null();
HXLINE( 356)		this->minValue = null();
HXLINE( 355)		this->changeValue = 1;
HXLINE( 354)		this->options = null();
HXLINE( 353)		this->curOption = 0;
HXLINE( 351)		this->defaultValue = null();
HXLINE( 350)		this->variable = null();
HXLINE( 348)		this->scrollSpeed = ((Float)50);
HXLINE( 347)		this->showBoyfriend = false;
HXLINE( 343)		this->type = HX_("bool",2a,84,1b,41);
HXLINE( 341)		this->onChange = null();
HXLINE( 365)		this->name = name;
HXLINE( 366)		this->variable = variable;
HXLINE( 367)		this->type = type;
HXLINE( 368)		this->defaultValue = defaultValue;
HXLINE( 369)		this->options = options;
HXLINE( 371)		if (::hx::IsEq( defaultValue,HX_("null variable value",06,3c,3f,e9) )) {
HXLINE( 373)			::String _hx_switch_0 = type;
            			if (  (_hx_switch_0==HX_("bool",2a,84,1b,41)) ){
HXLINE( 376)				defaultValue = false;
HXDLIN( 376)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("float",9c,c5,96,02)) ||  (_hx_switch_0==HX_("int",ef,0c,50,00)) ){
HXLINE( 378)				defaultValue = 0;
HXDLIN( 378)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("percent",c5,aa,da,78)) ){
HXLINE( 380)				defaultValue = 1;
HXDLIN( 380)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("string",d1,28,30,11)) ){
HXLINE( 382)				defaultValue = HX_("",00,00,00,00);
HXLINE( 383)				if ((options->length > 0)) {
HXLINE( 384)					defaultValue = options->__get(0);
            				}
HXLINE( 381)				goto _hx_goto_0;
            			}
            			_hx_goto_0:;
            		}
HXLINE( 389)		if (::hx::IsNull( this->getValue() )) {
HXLINE( 390)			this->setValue(defaultValue);
            		}
HXLINE( 393)		::String _hx_switch_1 = type;
            		if (  (_hx_switch_1==HX_("percent",c5,aa,da,78)) ){
HXLINE( 402)			this->displayFormat = HX_("%v%",54,7a,1c,00);
HXLINE( 403)			this->changeValue = ((Float)0.01);
HXLINE( 404)			this->minValue = 0;
HXLINE( 405)			this->maxValue = 1;
HXLINE( 406)			this->scrollSpeed = ((Float)0.5);
HXLINE( 407)			this->decimals = 2;
HXLINE( 401)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_1==HX_("string",d1,28,30,11)) ){
HXLINE( 396)			int num = options->indexOf(this->getValue(),null());
HXLINE( 397)			if ((num > -1)) {
HXLINE( 398)				this->curOption = num;
            			}
HXLINE( 395)			goto _hx_goto_1;
            		}
            		_hx_goto_1:;
            	}
...
void GameplayOption_obj::change(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_414_change)
HXDLIN( 414)		if (::hx::IsNotNull( this->onChange )) {
HXLINE( 415)			this->onChange();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GameplayOption_obj,change,(void))
 ...
 ::Dynamic GameplayOption_obj::getValue(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_421_getValue)
HXDLIN( 421)		return ::ClientPrefs_obj::gameplaySettings->get(this->variable);
            	}
...
void GameplayOption_obj::setValue( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_425_setValue)
HXDLIN( 425)		::ClientPrefs_obj::gameplaySettings->set(this->variable,value);
            	}
...
void GameplayOption_obj::setChild( ::Alphabet child){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_430_setChild)
HXDLIN( 430)		this->child = child;
            	}
...
::String GameplayOption_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_434_get_text)
HXLINE( 435)		if (::hx::IsNotNull( this->child )) {
HXLINE( 436)			return this->child->text;
            		}
...
::String GameplayOption_obj::set_text(::String __o_newValue){
            	...
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_441_set_text)
HXLINE( 442)		if (::hx::IsNotNull( this->child )) {
HXLINE( 443)			this->child->changeText(newValue,null());
            		}
...
::String GameplayOption_obj::get_type(){
            	HX_STACKFRAME(&_hx_pos_5355c1500aa58f96_449_get_type)
HXLINE( 450)		::String newValue = HX_("bool",2a,84,1b,41);
HXLINE( 451)		::String _hx_switch_0 = ::StringTools_obj::trim(this->type.toLowerCase());
            		if (  (_hx_switch_0==HX_("fl",46,59,00,00)) ){
HXLINE( 456)			newValue = HX_("float",9c,c5,96,02);
HXDLIN( 456)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("integer",be,bd,1b,17)) ){
HXLINE( 454)			newValue = HX_("int",ef,0c,50,00);
HXDLIN( 454)			goto _hx_goto_9;
            		}
...
HXLINE( 453)			newValue = this->type;
HXDLIN( 453)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("str",b1,a8,57,00)) ){
HXLINE( 455)			newValue = HX_("string",d1,28,30,11);
HXDLIN( 455)			goto _hx_goto_9;
            		}
            		_hx_goto_9:;
HXLINE( 458)		this->type = newValue;
HXLINE( 459)		return this->type;
            	}
