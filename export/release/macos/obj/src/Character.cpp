...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_81_reduceSize,"Character","reduceSize",0x8abdda4c,"Character.reduceSize","Character.hx",81,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_221_update,"Character","update",0x0e18944e,"Character.update","Character.hx",221,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_271_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",271,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_289_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",289,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_320_recalculateDanceIdle,"Character","recalculateDanceIdle",0x9672c319,"Character.recalculateDanceIdle","Character.hx",320,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_325_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",325,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_330_quickAnimAdd,"Character","quickAnimAdd",0x85c31d28,"Character.quickAnimAdd","Character.hx",330,0xf073a2d5)
...
HXLINE(  88)		this->animOffsets =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  92)		this->curCharacter = character;
HXLINE(  93)		this->isPlayer = ( (bool)(isPlayer) );
HXLINE(  94)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  96)		::String library = null();
HXLINE(  97)		{
HXLINE(  97)			::String _g = this->curCharacter;
HXLINE( 101)			{
HXLINE( 102)				::String characterPath = ((HX_("characters/",45,3c,bf,be) + this->curCharacter) + HX_(".json",56,f1,d6,c2));
HXLINE( 104)				::String path = ::Paths_obj::modFolders(characterPath);
HXLINE( 105)				if (!(::sys::FileSystem_obj::exists(path))) {
HXLINE( 106)					::String file = characterPath;
...
HXLINE( 115)					::String file = ((HX_("characters/",45,3c,bf,be) + ::Character_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN( 115)					if (::hx::IsNull( file )) {
HXLINE( 115)						file = HX_("",00,00,00,00);
            					}
HXDLIN( 115)					path = (HX_("assets/",4c,2a,dc,36) + file);
            				}
HXLINE( 119)				::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 124)				 ::Dynamic json =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 126)				::String modTxtToFind = ::Paths_obj::modFolders(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ));
HXLINE( 127)				::String txtToFind = ::Paths_obj::getPath(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ),HX_("TEXT",ad,94,ba,37),null());
HXLINE( 128)				bool _hx_tmp;
HXDLIN( 128)				bool _hx_tmp1;
HXDLIN( 128)				if (!(::sys::FileSystem_obj::exists(modTxtToFind))) {
HXLINE( 128)					_hx_tmp1 = ::sys::FileSystem_obj::exists(txtToFind);
            				}
            				else {
HXLINE( 128)					_hx_tmp1 = true;
            				}
HXDLIN( 128)				if (!(_hx_tmp1)) {
HXLINE( 128)					_hx_tmp = ::openfl::utils::Assets_obj::exists(txtToFind,null());
            				}
            				else {
...
HXDLIN( 134)					bool txtExists = false;
HXDLIN( 134)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))))) {
HXLINE( 134)						txtExists = true;
            					}
...
HXDLIN( 134)					if (txtExists) {
HXLINE( 134)						_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))));
            					}
            					else {
HXLINE( 134)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library);
            					}
HXDLIN( 134)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,_hx_tmp1));
            				}
            				else {
HXLINE( 138)					::String key = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 138)					::String library = null();
HXDLIN( 138)					 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 138)					bool xmlExists = false;
HXDLIN( 138)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 138)						xmlExists = true;
            					}
HXDLIN( 138)					 ::Dynamic _hx_tmp;
HXDLIN( 138)					if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 138)						_hx_tmp = imageLoaded;
            					}
            					else {
HXLINE( 138)						 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 138)						if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 138)							_hx_tmp = imageToReturn;
            						}
            						else {
HXLINE( 138)							_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            						}
            					}
HXDLIN( 138)					::String _hx_tmp1;
HXDLIN( 138)					if (xmlExists) {
HXLINE( 138)						_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
HXLINE( 138)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            					}
HXDLIN( 138)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
            				}
HXLINE( 140)				this->imageFile = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXLINE( 142)				if (::hx::IsNotEq( json->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic),1 )) {
HXLINE( 143)					this->jsonScale = ( (Float)(json->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) );
HXLINE( 144)					Float _hx_tmp = this->get_width();
HXDLIN( 144)					this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * this->jsonScale)),null());
HXLINE( 145)					this->updateHitbox();
            				}
HXLINE( 148)				this->positionArray = ( (::Array< Float >)(json->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXLINE( 149)				this->cameraPosition = ( (::Array< Float >)(json->__Field(HX_("camera_position",c3,d4,4a,56),::hx::paccDynamic)) );
HXLINE( 151)				this->healthIcon = ( (::String)(json->__Field(HX_("healthicon",15,8e,6f,17),::hx::paccDynamic)) );
HXLINE( 152)				this->singDuration = ( (Float)(json->__Field(HX_("sing_duration",84,ae,a8,66),::hx::paccDynamic)) );
HXLINE( 153)				this->set_flipX(( (bool)(json->__Field(HX_("flip_x",26,2b,6a,3d),::hx::paccDynamic)) ));
HXLINE( 154)				if (( (bool)(json->__Field(HX_("no_antialiasing",f2,74,67,98),::hx::paccDynamic)) )) {
HXLINE( 155)					this->set_antialiasing(false);
HXLINE( 156)					this->noAntialiasing = true;
            				}
HXLINE( 159)				bool _hx_tmp2;
HXDLIN( 159)				if (::hx::IsNotNull( json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic) )) {
HXLINE( 159)					_hx_tmp2 = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
HXLINE( 159)					_hx_tmp2 = false;
            				}
HXDLIN( 159)				if (_hx_tmp2) {
HXLINE( 160)					this->healthColorArray = ( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) );
            				}
HXLINE( 162)				this->set_antialiasing(!(this->noAntialiasing));
HXLINE( 163)				if (!(::ClientPrefs_obj::globalAntialiasing)) {
HXLINE( 163)					this->set_antialiasing(false);
            				}
HXLINE( 165)				this->animationsArray = ( (::Array< ::Dynamic>)(json->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) );
HXLINE( 166)				bool _hx_tmp3;
HXDLIN( 166)				if (::hx::IsNotNull( this->animationsArray )) {
HXLINE( 166)					_hx_tmp3 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXLINE( 167)					int _g = 0;
HXDLIN( 167)					::Array< ::Dynamic> _g1 = this->animationsArray;
HXDLIN( 167)					while((_g < _g1->length)){
HXLINE( 167)						 ::Dynamic anim = _g1->__get(_g);
HXDLIN( 167)						_g = (_g + 1);
HXLINE( 168)						::String animAnim = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))) );
HXLINE( 169)						::String animName = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic))) );
HXLINE( 170)						int animFps = ( (int)(anim->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) );
HXLINE( 171)						bool animLoop = ( (bool)(anim->__Field(HX_("loop",64,a6,b7,47),::hx::paccDynamic)) );
HXLINE( 172)						::Array< int > animIndices = ( (::Array< int >)(anim->__Field(HX_("indices",27,47,54,e3),::hx::paccDynamic)) );
HXLINE( 173)						bool _hx_tmp;
HXDLIN( 173)						if (::hx::IsNotNull( animIndices )) {
HXLINE( 173)							_hx_tmp = (animIndices->length > 0);
            						}
            						else {
HXLINE( 173)							_hx_tmp = false;
            						}
HXDLIN( 173)						if (_hx_tmp) {
HXLINE( 174)							this->animation->addByIndices(animAnim,animName,animIndices,HX_("",00,00,00,00),animFps,animLoop,null(),null());
            						}
            						else {
HXLINE( 176)							this->animation->addByPrefix(animAnim,animName,animFps,animLoop,null(),null());
            						}
HXLINE( 179)						bool _hx_tmp1;
HXDLIN( 179)						if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE( 179)							_hx_tmp1 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
HXLINE( 179)							_hx_tmp1 = false;
            						}
HXDLIN( 179)						if (_hx_tmp1) {
HXLINE( 180)							this->addOffset(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(1));
            						}
            					}
            				}
            				else {
HXLINE( 184)					this->quickAnimAdd(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f));
            				}
            			}
            		}
HXLINE( 188)		this->originalFlipX = this->flipX;
HXLINE( 190)		bool _hx_tmp4;
HXDLIN( 190)		bool _hx_tmp5;
HXDLIN( 190)		bool _hx_tmp6;
HXDLIN( 190)		if (!(this->animOffsets->exists(HX_("singLEFTmiss",d2,2f,9c,b6)))) {
HXLINE( 190)			_hx_tmp6 = this->animOffsets->exists(HX_("singDOWNmiss",ad,e9,88,e4));
            		}
            		else {
HXLINE( 190)			_hx_tmp6 = true;
            		}
HXDLIN( 190)		if (!(_hx_tmp6)) {
HXLINE( 190)			_hx_tmp5 = this->animOffsets->exists(HX_("singUPmiss",66,22,08,8a));
            		}
            		else {
HXLINE( 190)			_hx_tmp5 = true;
            		}
HXDLIN( 190)		if (!(_hx_tmp5)) {
HXLINE( 190)			_hx_tmp4 = this->animOffsets->exists(HX_("singRIGHTmiss",89,cc,65,e3));
            		}
            		else {
HXLINE( 190)			_hx_tmp4 = true;
            		}
HXDLIN( 190)		if (_hx_tmp4) {
HXLINE( 190)			this->hasMissAnimations = true;
            		}
HXLINE( 191)		this->recalculateDanceIdle();
HXLINE( 192)		this->dance();
HXLINE( 194)		if (( (bool)(isPlayer) )) {
HXLINE( 196)			this->set_flipX(!(this->flipX));
            		}
            	}
...
void Character_obj::reduceSize(Float perc){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_81_reduceSize)
HXDLIN(  81)		Float _hx_tmp = this->get_width();
HXDLIN(  81)		int _hx_tmp1 = ::Std_obj::_hx_int((_hx_tmp - ::Mathematics_obj::percentual(this->get_width(),perc)));
HXDLIN(  81)		Float _hx_tmp2 = this->get_height();
HXDLIN(  81)		this->setGraphicSize(_hx_tmp1,::Std_obj::_hx_int((_hx_tmp2 - ::Mathematics_obj::percentual(this->get_height(),perc))));
            	}


HX_DEFINE_DYNAMIC_FUNC1(Character_obj,reduceSize,(void))

void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_221_update)
HXLINE( 222)		bool _hx_tmp;
HXDLIN( 222)		if (!(this->debugMode)) {
HXLINE( 222)			_hx_tmp = ::hx::IsNotNull( this->animation->_curAnim );
            		}
            		else {
...
HXLINE( 226)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 226)				_hx_tmp->heyTimer = (_hx_tmp->heyTimer - elapsed);
HXLINE( 227)				if ((this->heyTimer <= 0)) {
HXLINE( 229)					bool _hx_tmp;
HXDLIN( 229)					bool _hx_tmp1;
HXDLIN( 229)					if (this->specialAnim) {
HXLINE( 229)						_hx_tmp1 = (this->animation->_curAnim->name == HX_("hey",dc,42,4f,00));
            					}
            					else {
HXLINE( 229)						_hx_tmp1 = false;
            					}
HXDLIN( 229)					if (!(_hx_tmp1)) {
HXLINE( 229)						_hx_tmp = (this->animation->_curAnim->name == HX_("cheer",8d,9a,b6,45));
            					}
            					else {
HXLINE( 229)						_hx_tmp = true;
            					}
HXDLIN( 229)					if (_hx_tmp) {
HXLINE( 231)						this->specialAnim = false;
HXLINE( 232)						this->dance();
            					}
HXLINE( 234)					this->heyTimer = ( (Float)(0) );
            				}
            			}
            			else {
HXLINE( 236)				bool _hx_tmp;
HXDLIN( 236)				if (this->specialAnim) {
HXLINE( 236)					_hx_tmp = this->animation->_curAnim->finished;
            				}
            				else {
HXLINE( 236)					_hx_tmp = false;
            				}
HXDLIN( 236)				if (_hx_tmp) {
HXLINE( 238)					this->specialAnim = false;
HXLINE( 239)					this->dance();
            				}
            			}
HXLINE( 242)			if (!(this->isPlayer)) {
HXLINE( 244)				if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 246)					 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 246)					_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            				}
HXLINE( 249)				if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * ((Float)0.001)) * this->singDuration))) {
HXLINE( 251)					this->dance();
HXLINE( 252)					this->holdTimer = ( (Float)(0) );
            				}
            			}
HXLINE( 256)			bool _hx_tmp;
HXDLIN( 256)			if (this->animation->_curAnim->finished) {
HXLINE( 256)				_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30))) );
            			}
            			else {
HXLINE( 256)				_hx_tmp = false;
            			}
HXDLIN( 256)			if (_hx_tmp) {
HXLINE( 258)				this->playAnim((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30)),null(),null(),null());
            			}
            		}
...
void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_271_dance)
HXDLIN( 271)		bool _hx_tmp;
HXDLIN( 271)		if (!(this->debugMode)) {
HXDLIN( 271)			_hx_tmp = !(this->specialAnim);
            		}
            		else {
HXDLIN( 271)			_hx_tmp = false;
            		}
HXDLIN( 271)		if (_hx_tmp) {
HXLINE( 273)			if (this->danceIdle) {
HXLINE( 275)				this->danced = !(this->danced);
HXLINE( 277)				if (this->danced) {
HXLINE( 278)					this->playAnim((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix),null(),null(),null());
            				}
            				else {
HXLINE( 280)					this->playAnim((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix),null(),null(),null());
            				}
            			}
            			else {
HXLINE( 282)				if (::hx::IsNotNull( this->animation->_animations->get((HX_("idle",14,a7,b3,45) + this->idleSuffix)) )) {
HXLINE( 283)					this->playAnim((HX_("idle",14,a7,b3,45) + this->idleSuffix),null(),null(),null());
            				}
            			}
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_289_playAnim)
HXLINE( 290)		this->specialAnim = false;
HXLINE( 291)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 293)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 294)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 296)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 299)			this->offset->set(0,0);
            		}
HXLINE( 301)		if (::StringTools_obj::startsWith(this->curCharacter,HX_("gf",1f,5a,00,00))) {
HXLINE( 303)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 305)				this->danced = true;
            			}
            			else {
HXLINE( 307)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 309)					this->danced = false;
            				}
            			}
HXLINE( 312)			bool _hx_tmp;
HXDLIN( 312)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 312)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 312)				_hx_tmp = true;
            			}
HXDLIN( 312)			if (_hx_tmp) {
HXLINE( 314)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::recalculateDanceIdle(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_320_recalculateDanceIdle)
HXDLIN( 320)		bool _hx_tmp;
HXDLIN( 320)		if (::hx::IsNotNull( this->animation->_animations->get((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix)) )) {
HXDLIN( 320)			_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix)) );
            		}
            		else {
HXDLIN( 320)			_hx_tmp = false;
            		}
HXDLIN( 320)		this->danceIdle = _hx_tmp;
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_325_addOffset)
HXDLIN( 325)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 325)		this->animOffsets->set(name,v);
            	}
...
void Character_obj::quickAnimAdd(::String name,::String anim){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_330_quickAnimAdd)
HXDLIN( 330)		this->animation->addByPrefix(name,anim,24,false,null(),null());
            	}
...
::hx::Val Character_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"reduceSize") ) { return ::hx::Val( reduceSize_dyn() ); }
		break;
	case 11:
