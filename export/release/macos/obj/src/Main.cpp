...
HXLINE(  88)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  92)		::Main_obj::fpsVar =  ::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
...
bool Main_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"fpsVar") ) { fpsVar=ioValue.Cast<  ::FPS >(); return true; }
...
static ::hx::StaticInfo Main_obj_sStaticStorageInfo[] = {
	{::hx::fsObject /*  ::FPS */ ,(void *) &Main_obj::fpsVar,HX_("fpsVar",7e,e6,8c,91)},
...
HXDLIN(  36)		modVer = HX_("0.9.5",82,11,cf,c1);
            	}
{
