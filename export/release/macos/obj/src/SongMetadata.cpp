...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_521_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",521,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_521_new)
HXLINE( 527)		this->folder = HX_("",00,00,00,00);
HXLINE( 526)		this->color = -7179779;
HXLINE( 525)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 524)		this->week = 0;
HXLINE( 523)		this->songName = HX_("",00,00,00,00);
HXLINE( 531)		this->songName = song;
HXLINE( 532)		this->week = week;
HXLINE( 533)		this->songCharacter = songCharacter;
HXLINE( 534)		this->color = color;
HXLINE( 535)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 536)		if (::hx::IsNull( this->folder )) {
HXLINE( 536)			this->folder = HX_("",00,00,00,00);
            		}
            	}
