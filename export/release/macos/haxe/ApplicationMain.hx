...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Military", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Military", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Military Inc.";
		app.meta["file"] = "Military";
		app.meta["name"] = "VS Military Man";
