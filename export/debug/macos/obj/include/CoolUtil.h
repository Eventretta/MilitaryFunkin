...
class HXCPP_CLASS_ATTRIBUTES CoolUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static void startTracePushing();
		static ::Dynamic startTracePushing_dyn();
		...
		static ::String getSysPath(::String song);
		static ::Dynamic getSysPath_dyn();

		static void loadPreloadImage();
		static ::Dynamic loadPreloadImage_dyn();

		static void saveWithoutDialogue(::String song,::String diff,::String daJson);
		static ::Dynamic saveWithoutDialogue_dyn();
		...
		static ::String replayPath(::String name);
		static ::Dynamic replayPath_dyn();
