...
class HXCPP_CLASS_ATTRIBUTES MainMenuState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static ::Array< ::String > gamejoltthings;
		static bool gamejolto;
		static bool discord;
		static bool comeFromFarm;
		...
		::Array< ::String > optionShit;
		 ...
		 ::openfl::display::BitmapData susavatar;
		 ::flixel::FlxObject camFollow;
		 ::flixel::FlxObject camFollowPos;
		::Array< int > debugKeys;
		 ::flixel::FlxSprite god;
		int godtime;
		void create();
		...
		void changeItem(::hx::Null< int >  huh,::hx::Null< bool >  set);
