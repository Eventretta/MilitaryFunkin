...
class HXCPP_CLASS_ATTRIBUTES LoadingScreen_obj : public  ::MusicBeatState_obj
{
	public:
	...
	public:
		...
		static ::hx::ObjectPtr< LoadingScreen_obj > __new( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut);
		static ::hx::ObjectPtr< LoadingScreen_obj > __alloc(::hx::Ctx *_hx_ctx, ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut);
