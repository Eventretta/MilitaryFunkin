...
#define INCLUDED_editors_FreeplayEditor
...
HX_DECLARE_CLASS1(editors,FreeplayEditor)
...
class HXCPP_CLASS_ATTRIBUTES FreeplayEditor_obj : public  ::MusicBeatSubstate_obj
{
	public:
		typedef  ::MusicBeatSubstate_obj super;
		typedef FreeplayEditor_obj OBJ_;
		FreeplayEditor_obj();

	public:
		enum { _hx_ClassId = 0x25971cb3 };

		void __construct(Float startPos);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="editors.FreeplayEditor")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"editors.FreeplayEditor"); }
		static ::hx::ObjectPtr< FreeplayEditor_obj > __new(Float startPos);
		static ::hx::ObjectPtr< FreeplayEditor_obj > __alloc(::hx::Ctx *_hx_ctx,Float startPos);
		...
		::String __ToString() const { return HX_("FreeplayEditor",8d,12,04,f6); }

		static  ::editors::FreeplayEditor instance;
...
#endif /* INCLUDED_editors_FreeplayEditor */ 
