...
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_36_unlockAchievement,"Achievements","unlockAchievement",0xddbd5e61,"Achievements.unlockAchievement","Achievements.hx",36,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_42_isAchievementUnlocked,"Achievements","isAchievementUnlocked",0x1e700b3e,"Achievements.isAchievementUnlocked","Achievements.hx",42,0xf249f7fa)
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_49_getAchievementIndex,"Achievements","getAchievementIndex",0x4a8ffcaf,"Achievements.getAchievementIndex","Achievements.hx",49,0xf249f7fa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_51d0672471f6b710_35_boot,"Achievements","boot",0x8eb5af9c,"Achievements.boot","Achievements.hx",35,0xf249f7fa)
...
void Achievements_obj::unlockAchievement(::String name){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_36_unlockAchievement)
HXLINE(  37)		::flixel::FlxG_obj::log->advanced(((HX_("Completed achievement \"",bc,88,62,0c) + name) + HX_("\"",22,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
HXLINE(  38)		::Achievements_obj::achievementsMap->set(name,true);
HXLINE(  39)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  39)		_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
            	}
...
bool Achievements_obj::isAchievementUnlocked(::String name){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_42_isAchievementUnlocked)
HXLINE(  43)		bool _hx_tmp;
HXDLIN(  43)		if (::Achievements_obj::achievementsMap->exists(name)) {
HXLINE(  43)			_hx_tmp = ::Achievements_obj::achievementsMap->get_bool(name);
            		}
            		else {
...
int Achievements_obj::getAchievementIndex(::String name){
            	HX_STACKFRAME(&_hx_pos_51d0672471f6b710_49_getAchievementIndex)
HXLINE(  50)		{
HXLINE(  50)			int _g = 0;
HXDLIN(  50)			int _g1 = ::Achievements_obj::achievementsStuff->get_length();
HXDLIN(  50)			while((_g < _g1)){
HXLINE(  50)				_g = (_g + 1);
HXDLIN(  50)				int i = (_g - 1);
HXLINE(  51)				if (::hx::IsEq( ::Achievements_obj::achievementsStuff->__get(i)->__GetItem(2),name )) {
HXLINE(  52)					return i;
            				}
            			}
            		}
...
HXLINE(  60)			if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("achievementsMap",d8,6f,d5,91),::hx::paccDynamic) )) {
HXLINE(  61)				::Achievements_obj::achievementsMap = ( ( ::haxe::ds::StringMap)(::flixel::FlxG_obj::save->data->__Field(HX_("achievementsMap",d8,6f,d5,91),::hx::paccDynamic)) );
            			}
HXLINE(  63)			if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("achievementsUnlocked",67,55,27,1c),::hx::paccDynamic) )) {
HXLINE(  64)				::flixel::FlxG_obj::log->advanced(HX_("Trying to load stuff",c6,1c,d3,26),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
HXLINE(  65)				::Array< ::String > savedStuff = ( (::Array< ::String >)(::flixel::FlxG_obj::save->data->__Field(HX_("achievementsUnlocked",67,55,27,1c),::hx::paccDynamic)) );
HXLINE(  66)				{
HXLINE(  66)					int _g = 0;
HXDLIN(  66)					int _g1 = savedStuff->length;
HXDLIN(  66)					while((_g < _g1)){
HXLINE(  66)						_g = (_g + 1);
HXDLIN(  66)						int i = (_g - 1);
HXLINE(  67)						::Achievements_obj::achievementsMap->set(savedStuff->__get(i),true);
            					}
            				}
            			}
HXLINE(  70)			bool _hx_tmp;
HXDLIN(  70)			if ((::Achievements_obj::henchmenDeath == 0)) {
HXLINE(  70)				_hx_tmp = ::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("henchmenDeath",f4,76,2a,dd),::hx::paccDynamic) );
            			}
            			else {
HXLINE(  70)				_hx_tmp = false;
            			}
HXDLIN(  70)			if (_hx_tmp) {
HXLINE(  71)				::Achievements_obj::henchmenDeath = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("henchmenDeath",f4,76,2a,dd),::hx::paccDynamic)) );
            			}
            		}
            	}
