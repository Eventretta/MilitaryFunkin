...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1001_loadGraphicFromSprite,"flixel.group.FlxTypedSpriteGroup","loadGraphicFromSprite",0x6f12dc84,"flixel.group.FlxTypedSpriteGroup.loadGraphicFromSprite","flixel/group/FlxSpriteGroup.hx",1001,0xeb1fa7f3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1024_loadRotatedGraphic,"flixel.group.FlxTypedSpriteGroup","loadRotatedGraphic",0x45e23732,"flixel.group.FlxTypedSpriteGroup.loadRotatedGraphic","flixel/group/FlxSpriteGroup.hx",1024,0xeb1fa7f3)
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1036_makeGraphic,"flixel.group.FlxTypedSpriteGroup","makeGraphic",0x27a1d44d,"flixel.group.FlxTypedSpriteGroup.makeGraphic","flixel/group/FlxSpriteGroup.hx",1036,0xeb1fa7f3)
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSpriteGroup_obj,scrollFactorCallback,(void))
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadGraphicFromSprite( ::flixel::FlxSprite Sprite){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1001_loadGraphicFromSprite)
HXDLIN(1001)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
HXDLIN(1001)		return null();
            	}
...
HXDLIN(1013)		return ::hx::ObjectPtr<OBJ_>(this);
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1024_loadRotatedGraphic)
HXDLIN(1024)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
HXDLIN(1024)		return null();
            	}
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            		...
            		bool Unique = __o_Unique.Default(false);
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1036_makeGraphic)
HXDLIN(1036)		int Color = _tmp_Color;
HXDLIN(1036)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
