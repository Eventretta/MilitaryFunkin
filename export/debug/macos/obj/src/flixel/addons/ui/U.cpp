...
HXDLIN( 462)							 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 455)							if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE( 462)								::String msg = ( (::String)(_g1) );
HXLINE( 464)								::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            							}
            							else {
