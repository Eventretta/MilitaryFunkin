...
HXLINE( 320)			::flixel::FlxG_obj::log->advanced(HX_("FlxGameJolt: Unable to access user name or token, and no user name or token was passed.",1c,d5,6b,76),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
            	}
...
HXLINE( 694)		if (::flixel::addons::api::FlxGameJolt_obj::verbose) {
HXLINE( 695)			::flixel::FlxG_obj::log->advanced((HX_("FlxGameJolt: Contacting ",e7,75,4b,8c) + request->url),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            		}
...
HXLINE( 717)			::flixel::FlxG_obj::log->advanced(HX_("FlxGameJolt received no data back. This is probably because one of the values it was passed is wrong.",f0,15,80,84),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 719)			return;
            		}
...
HXDLIN( 741)		if (returnMap->exists(HX_("message",c7,35,11,9a))) {
HXLINE( 741)			_hx_tmp = ::flixel::addons::api::FlxGameJolt_obj::verbose;
            		}
            		else {
HXLINE( 741)			_hx_tmp = false;
            		}
HXDLIN( 741)		if (_hx_tmp) {
HXLINE( 743)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 743)			 ::Dynamic Data = (HX_("FlxGameJolt: GameJolt returned the following message: ",c8,29,3e,b5) + returnMap->get_string(HX_("message",c7,35,11,9a)));
HXDLIN( 743)			_this->advanced(Data,::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            		}
...
HXLINE( 753)			_hx_tmp1 = !(::flixel::addons::api::FlxGameJolt_obj::_verifyAuth);
            		}
            		else {
...
HXLINE( 856)				::flixel::FlxG_obj::log->advanced(HX_("FlxGameJolt: Failed to load image",5a,13,83,6b),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            			}
            		}
            	}
...
HXLINE( 901)			::flixel::FlxG_obj::log->advanced(((((HX_("FlxGameJolt: You must run init() before you can do this. Game ID is ",b1,fb,e8,e2) + ::flixel::addons::api::FlxGameJolt_obj::_gameID) + HX_(" and the key is ",5d,60,02,de)) + ::flixel::addons::api::FlxGameJolt_obj::_privateKey) + HX_(".",2e,00,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 921)			::flixel::FlxG_obj::log->advanced(HX_("FlxGameJolt: You must authenticate user before you can do this.",a4,58,4e,b5),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
