...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_389_checkByName,"Controls","checkByName",0xbe587cd2,"Controls.checkByName","Controls.hx",389,0x0ab041e8)
...
bool Controls_obj::checkByName(::String name){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_389_checkByName)
HXLINE( 391)		if (!(this->byName->exists(name))) {
HXLINE( 392)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Invalid name: ",da,fb,f0,ea) + name)));
            		}
HXLINE( 394)		return ( ( ::flixel::input::actions::FlxActionDigital)(this->byName->get(name)) )->check();
            	}
