...
HXLINE(  25)		this->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,HX_("_sans",32,a0,5e,ff),12,inCol,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
