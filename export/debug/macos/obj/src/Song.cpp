...
HX_DEFINE_STACK_FRAME(_hx_pos_4e288e2989890fc6_36_new,"Song","new",0xfb6c8f67,"Song.new","Song.hx",36,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_54_onLoadJson,"Song","onLoadJson",0xe02d2786,"Song.onLoadJson","Song.hx",54,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_94_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",94,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_143_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",143,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_36_new)
HXLINE(  51)		this->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  50)		this->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  49)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  48)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  45)		this->speed = ((Float)1);
HXLINE(  42)		this->needsVoices = true;
HXLINE(  88)		this->song = song;
HXLINE(  89)		this->notes = notes;
HXLINE(  90)		this->bpm = bpm;
            	}
...
void Song_obj::onLoadJson( ::Dynamic songJson){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_54_onLoadJson)
HXLINE(  55)		if (::hx::IsNull( songJson->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic) )) {
HXLINE(  57)			songJson->__SetField(HX_("gfVersion",b9,c6,7d,f3),songJson->__Field(HX_("player3",b2,09,15,8a),::hx::paccDynamic),::hx::paccDynamic);
HXLINE(  58)			songJson->__SetField(HX_("player3",b2,09,15,8a),null(),::hx::paccDynamic);
            		}
HXLINE(  61)		if (::hx::IsNull( songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic) )) {
HXLINE(  63)			songJson->__SetField(HX_("events",19,4f,6a,96),::cpp::VirtualArray_obj::__new(0),::hx::paccDynamic);
HXLINE(  64)			{
HXLINE(  64)				int _g = 0;
HXDLIN(  64)				int _g1 = ( (::Array< ::Dynamic>)(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) )->length;
HXDLIN(  64)				while((_g < _g1)){
HXLINE(  64)					_g = (_g + 1);
HXDLIN(  64)					int secNum = (_g - 1);
HXLINE(  66)					 ::Dynamic sec =  ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(secNum);
HXLINE(  68)					int i = 0;
HXLINE(  69)					::cpp::VirtualArray notes = ( (::cpp::VirtualArray)(sec->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXLINE(  70)					int len = notes->get_length();
HXLINE(  71)					while((i < len)){
HXLINE(  73)						::cpp::VirtualArray note = ( (::cpp::VirtualArray)(notes->__get(i)) );
HXLINE(  74)						if (::hx::IsLess( note->__get(1),0 )) {
HXLINE(  76)							( (::cpp::VirtualArray)(songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic)) )->push(::cpp::VirtualArray_obj::__new(2)->init(0,note->__get(0))->init(1,::cpp::VirtualArray_obj::__new(1)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,note->__get(2))->init(1,note->__get(3))->init(2,note->__get(4)))));
HXLINE(  77)							notes->remove(note);
HXLINE(  78)							len = notes->get_length();
            						}
            						else {
HXLINE(  80)							i = (i + 1);
            						}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_94_loadFromJson)
HXLINE(  95)		::String rawJson = null();
HXLINE(  97)		::String formattedFolder = ::StringTools_obj::replace(folder.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE(  98)		::String formattedSong = ::StringTools_obj::replace(jsonInput.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 100)		::String moddyFile = ::Paths_obj::modFolders(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
HXLINE( 101)		if (::sys::FileSystem_obj::exists(moddyFile)) {
HXLINE( 102)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(moddyFile));
            		}
HXLINE( 106)		if (::hx::IsNull( rawJson )) {
HXLINE( 108)			::String library = null();
HXDLIN( 108)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
            		}
HXLINE( 114)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE( 116)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE( 136)		 ::Dynamic songJson = ::Song_obj::parseJSONshit(rawJson);
HXLINE( 137)		if ((jsonInput != HX_("events",19,4f,6a,96))) {
HXLINE( 137)			::StageData_obj::loadDirectory(songJson);
            		}
HXLINE( 138)		::Song_obj::onLoadJson(songJson);
HXLINE( 139)		return songJson;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_143_parseJSONshit)
HXLINE( 144)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE( 145)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE( 146)		return swagShit;
            	}
