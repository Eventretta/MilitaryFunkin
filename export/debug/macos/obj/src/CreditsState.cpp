...
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_224_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",224,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_242_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",242,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_264_getCurrentBGColor,"CreditsState","getCurrentBGColor",0xd6c58504,"CreditsState.getCurrentBGColor","CreditsState.hx",264,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_273_unselectableCheck,"CreditsState","unselectableCheck",0x4473c3a2,"CreditsState.unselectableCheck","CreditsState.hx",273,0xdb40a967)
...
HXLINE(  83)		::Array< ::Dynamic> pisspoop = ::Array_obj< ::Dynamic>::__new(47)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_9,1))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_10,5))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_11,5))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_12,5))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_13,5))->init(5,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_14,5))->init(6,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_15,5))->init(7,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_16,5))->init(8,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_17,5))->init(9,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_18,5))->init(10,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_19,5))->init(11,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_20,5))->init(12,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_21,5))->init(13,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_22,5))->init(14,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_23,5))->init(15,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_24,5))->init(16,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_25,5))->init(17,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_26,5))->init(18,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_27,5))->init(19,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_28,5))->init(20,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_29,5))->init(21,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_30,5))->init(22,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_31,5))->init(23,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_32,5))->init(24,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_33,5))->init(25,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_34,5))->init(26,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_35,1))->init(27,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_36,5))->init(28,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_37,5))->init(29,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_38,1))->init(30,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_39,1))->init(31,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_40,5))->init(32,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_41,5))->init(33,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_42,5))->init(34,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_43,1))->init(35,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_44,1))->init(36,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_45,5))->init(37,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_46,5))->init(38,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_47,5))->init(39,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_48,5))->init(40,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_49,5))->init(41,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_50,1))->init(42,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_51,1))->init(43,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_52,5))->init(44,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_53,5))->init(45,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_54,5))->init(46,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_55,5));
HXLINE( 133)		{
HXLINE( 133)			int _g2 = 0;
HXDLIN( 133)			while((_g2 < pisspoop->length)){
HXLINE( 133)				::Array< ::String > i = pisspoop->__get(_g2).StaticCast< ::Array< ::String > >();
HXDLIN( 133)				_g2 = (_g2 + 1);
HXLINE( 134)				this->creditsStuff->push(i);
            			}
            		}
HXLINE( 137)		{
HXLINE( 137)			int _g3 = 0;
HXDLIN( 137)			int _g4 = this->creditsStuff->length;
HXDLIN( 137)			while((_g3 < _g4)){
HXLINE( 137)				_g3 = (_g3 + 1);
HXDLIN( 137)				int i = (_g3 - 1);
HXLINE( 139)				bool isSelectable = !(this->unselectableCheck(i));
HXLINE( 140)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)((70 * i)) ),this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(0),!(isSelectable),false,null(),null());
HXLINE( 141)				optionText->isMenuItem = true;
HXLINE( 142)				optionText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 143)				 ::Alphabet optionText1 = optionText;
HXDLIN( 143)				optionText1->yAdd = (optionText1->yAdd - ( (Float)(70) ));
HXLINE( 144)				if (isSelectable) {
HXLINE( 145)					optionText->set_x((optionText->x - ( (Float)(70) )));
            				}
HXLINE( 147)				optionText->forceX = optionText->x;
HXLINE( 149)				optionText->targetY = ( (Float)(i) );
HXLINE( 150)				this->grpOptions->add(optionText).StaticCast<  ::Alphabet >();
HXLINE( 152)				if (isSelectable) {
HXLINE( 153)					if (::hx::IsNotNull( this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(5) )) {
HXLINE( 155)						::Paths_obj::currentModDirectory = this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(5);
            					}
HXLINE( 158)					 ::AttachedSprite icon =  ::AttachedSprite_obj::__alloc( HX_CTX ,(HX_("credits/",d5,48,ee,de) + this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(1)),null(),null(),null());
HXLINE( 159)					icon->xAdd = (optionText->get_width() + 10);
HXLINE( 160)					icon->sprTracker = optionText;
HXLINE( 163)					this->iconArray->push(icon);
HXLINE( 164)					this->add(icon);
HXLINE( 165)					::Paths_obj::currentModDirectory = HX_("",00,00,00,00);
HXLINE( 167)					if ((this->curSelected == -1)) {
HXLINE( 167)						this->curSelected = i;
            					}
            				}
            			}
            		}
HXLINE( 171)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,50,600,1180,HX_("",00,00,00,00),32,null());
HXLINE( 172)		 ::flixel::text::FlxText _hx_tmp2 = this->descText;
HXDLIN( 172)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN( 172)		::String _hx_tmp3;
HXDLIN( 172)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 172)			_hx_tmp3 = file;
            		}
            		else {
HXLINE( 172)			_hx_tmp3 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN( 172)		_hx_tmp2->setFormat(_hx_tmp3,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 173)		this->descText->scrollFactor->set(null(),null());
HXLINE( 174)		this->descText->set_borderSize(((Float)2.4));
HXLINE( 175)		this->add(this->descText);
HXLINE( 177)		 ::flixel::FlxSprite _hx_tmp4 = this->bg;
HXDLIN( 177)		_hx_tmp4->set_color(( (int)(this->getCurrentBGColor()) ));
HXLINE( 178)		this->intendedColor = this->bg->color;
...
HXLINE( 187)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 187)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 190)		bool upP = ::PlayerSettings_obj::player1->controls->_ui_upP->check();
HXLINE( 191)		bool downP = ::PlayerSettings_obj::player1->controls->_ui_downP->check();
HXLINE( 193)		if (upP) {
HXLINE( 195)			this->changeSelection(-1);
            		}
HXLINE( 197)		if (downP) {
HXLINE( 199)			this->changeSelection(1);
HXLINE( 200)			 ::CreditsState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 200)			_hx_tmp->downtime = (_hx_tmp->downtime + 1);
HXLINE( 201)			if ((this->downtime >= this->creditsStuff->length)) {
HXLINE( 203)				this->unlockIntended = true;
            			}
            		}
...
HXDLIN( 212)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 213)			::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 216)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 218)			::flixel::addons::api::FlxGameJolt_obj::addTrophy(160970,null());
            		}
...
void CreditsState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_224_changeSelection)
HXDLIN( 224)		 ::CreditsState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 227)			 ::CreditsState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 227)			_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 228)			if ((this->curSelected < 0)) {
HXLINE( 229)				this->curSelected = (this->creditsStuff->length - 1);
            			}
HXLINE( 230)			if ((this->curSelected >= this->creditsStuff->length)) {
HXLINE( 231)				this->curSelected = 0;
            			}
HXLINE( 226)			if (!(this->unselectableCheck(this->curSelected))) {
HXLINE( 226)				goto _hx_goto_57;
            			}
            		}
            		_hx_goto_57:;
HXLINE( 234)		int newColor = ( (int)(this->getCurrentBGColor()) );
HXLINE( 235)		if ((newColor != this->intendedColor)) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CreditsState,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_242_changeSelection)
HXLINE( 242)				_gthis->colorTween = null();
            			}
...
HXLINE( 239)			this->intendedColor = newColor;
HXLINE( 240)			this->colorTween = ::flixel::tweens::FlxTween_obj::color(this->bg,1,this->bg->color,this->intendedColor, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("onComplete",f8,d4,7e,5d), ::Dynamic(new _hx_Closure_0(_gthis)))));
            		}
HXLINE( 247)		int bullShit = 0;
HXLINE( 249)		{
HXLINE( 249)			int _g = 0;
HXDLIN( 249)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
...
HXLINE( 254)				if (!(this->unselectableCheck((bullShit - 1)))) {
HXLINE( 255)					item->set_alpha(((Float)0.6));
HXLINE( 256)					if ((item->targetY == 0)) {
HXLINE( 257)						item->set_alpha(( (Float)(1) ));
            					}
            				}
            			}
            		}
HXLINE( 261)		this->descText->set_text(this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(2));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(CreditsState_obj,changeSelection,(void))
 ...
 ::Dynamic CreditsState_obj::getCurrentBGColor(){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_264_getCurrentBGColor)
HXLINE( 265)		::String bgColor = this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(4);
HXLINE( 266)		if (!(::StringTools_obj::startsWith(bgColor,HX_("0x",48,2a,00,00)))) {
HXLINE( 267)			bgColor = (HX_("0xFF",88,89,15,20) + bgColor);
            		}
HXLINE( 269)		return ::Std_obj::parseInt(bgColor);
            	}
...
bool CreditsState_obj::unselectableCheck(int num){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_273_unselectableCheck)
HXDLIN( 273)		return (this->creditsStuff->__get(num).StaticCast< ::Array< ::String > >()->length <= 1);
            	}
